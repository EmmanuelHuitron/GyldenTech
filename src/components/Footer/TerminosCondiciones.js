...
const TerminosCondiciones = () => {
  return (
    <div className="principal">
      ...
      <h3 className="subtitle-h3">A. USO.</h3>
      <p>
      ...
      <h3 className="subtitle-h3">B. RESTRICCIONES.</h3>
      <p style={{marginBottom: '30px'}}>
      ...
      <h3 className="subtitle-h3">D. OBLIGACIONES Y DEBERES DEL USUARIO.</h3>
      <p>
      ...
      <h3 className="subtitle-h3">E. PROHIBICIONES.</h3>
      ...
      <h3 className="subtitle-h3">I. AVISO DE PRIVACIDAD.</h3>
      <p style={{marginBottom: '30px'}}>
